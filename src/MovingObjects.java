...
public abstract class MovingObjects extends GameObject {
	...
	protected void moveRight() {super.xposition++;}
	protected void moveLeft() {super.xposition--;}
	protected void moveDown() {super.yposition++;}
	protected void moveUp() {super.yposition--;}
